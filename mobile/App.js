...
import { initializeModel } from './src/services/inferenceService';
...
export default function App() {
  ...
  // Initialize the TFLite model on startup so it's ready for immediate inference
  // (Failure is non-fatal; it will fall back to server inference)
  useEffect(() => {
    initializeModel();
  }, []);
